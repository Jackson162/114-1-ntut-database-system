...
async def get_cart_details(
    ...
    stmt = (
        select(
            ...
            Book.author,
            # 使用 literal 處理圖片預設值
            Book.image_url if hasattr(Book, "image_url") else literal("https://placehold.co/120x160").label("image_url"), 
        ...
        .join(BookBookstoreMapping, BookBookstoreMapping.book_bookstore_mapping_id == CartItem.book_bookstore_mapping_id)
